...
user_response = input()
print("My first love, " + user_response + ", broke my heart for the first time.")
...
# Check user's response and display the corresponding message
if user_response.lower() == "cops":
    print("They see me rolling. They hating. They hoping they gonna catch me riding dirty!")
elif user_response.lower() == "wardens":
